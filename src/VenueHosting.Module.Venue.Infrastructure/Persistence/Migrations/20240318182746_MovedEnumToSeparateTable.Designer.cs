...
namespace VenueHosting.Module.Venue.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240318182746_MovedEnumToSeparateTable")]
    partial class MovedEnumToSeparateTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Component.Persistence.SqlServer.Conventions.EnumConvention+EnumIdNameEntity<VenueHosting.Module.Venue.Domain.Aggregates.Venue.ValueObjects.VenueStatus>", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Component.Persistence.SqlServer.Conventions.EnumConvention+EnumIdNameEntity<VenueHosting.Module.Venue.Domain.Aggregates.Venue.ValueObjects.Visibility>", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VenueHosting.Module.Venue.Domain.Aggregates.Venue.Venue", b =>
                {
                    b.HasOne("Component.Persistence.SqlServer.Conventions.EnumConvention+EnumIdNameEntity<VenueHosting.Module.Venue.Domain.Aggregates.Venue.ValueObjects.VenueStatus>", null)
                        .WithMany()
                        .HasForeignKey("VenueStatus")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Component.Persistence.SqlServer.Conventions.EnumConvention+EnumIdNameEntity<VenueHosting.Module.Venue.Domain.Aggregates.Venue.ValueObjects.Visibility>", null)
                        .WithMany()
